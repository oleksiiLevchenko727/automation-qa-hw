...
const oldestBook = TheOldestBook.findOldestBook(books);
console.log(`The oldest book is: "${oldestBook.name}" by ${oldestBook.author}, released in ${oldestBook.releaseYear}.`);
